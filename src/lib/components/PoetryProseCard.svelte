...
<Card class=" bg-[#f7f3ef] my-8 flex {type == 'poetry' ? 'items-center' : 'items-start' } rounded-none" size="md" >
    <h5 class="mb-1 text-2xl font-bold tracking-tight text-gray-900">{header}</h5>
